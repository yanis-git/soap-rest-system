...
abstract class Model_Data_Base extends Model_Abstract{
	...
	public function findByLimit(array $params,$limit = 100, $offset = 0){
		$data = $this->_wrapper->select($this->table,$params, $limit,$offset);
		if(!empty($data)){
			return $data;
		}
		else{
	...
	public function fetchAll($order_by = null){
		return $this->_wrapper->select($this->table,array(), null, null, $order_by);
	}
	...
	public function delete($params){
		return $this->_wrapper->delete($this->table,$params);
	}
}